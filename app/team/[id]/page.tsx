...
import { getTeamEvents } from "@/lib/insights/pitch";
...
export default async function TeamPage({
  ...
  const events = await getTeamEvents(profile.id);
        ...
        <Section title="Shots and passes">
          {hasEvents ? (
            ...
            <p className="md-small" style={{ color: "var(--md-text-lo)" }}>
              No event coordinates are available for this team in the current data.
